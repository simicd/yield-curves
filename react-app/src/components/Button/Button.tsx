      ...
      <button
        className={clsx(
          "flex items-center justify-center w-full transition duration-150 ease-in-out border border-transparent rounded-md focus:outline-none focus:shadow-outline-teal",
          {
            ...
            "text-white bg-teal-600 bg-gradient-to-tr from-teal-500 to-blue-800 hover:text-white hover:from-teal-400 hover:to-blue-700 focus:from-teal-400 focus:to-blue-700": theme === "primary",
