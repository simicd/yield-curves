          ...
          <div className="flex flex-col justify-between flex-1 p-6 border-t-2 border-gray-100 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
            <ul>
              <li className="flex items-start">
                ...
                <p className="ml-3 text-base font-medium leading-6 text-gray-500">Pariatur quod similique</p>
              </li>
              <li className="flex items-start mt-4">
                <div className="flex-shrink-0">
                  <CheckmarkIcon />
                </div>
                <p className="ml-3 text-base font-medium leading-6 text-gray-500">Sapiente libero doloribus</p>
              </li>
              <li className="flex items-start mt-4">
                <div className="flex-shrink-0">
                  <CheckmarkIcon />
                </div>
                <p className="ml-3 text-base font-medium leading-6 text-gray-500">Vel ipsa esse repudiandae</p>
              </li>
            </ul>
            <div className="mt-8">
        ...
        <div className="px-6 pt-10 pb-8 border-t-2 border-gray-100 rounded-b-lg bg-gray-50 sm:px-10 sm:py-10">
          <ul>
            <li className="flex items-start">
              ...
              <p className="ml-3 text-base font-medium leading-6 text-gray-500">Quia rem est sed impedit magnam</p>
            </li>
            <li className="flex items-start mt-4">
              <div className="flex-shrink-0">
                <CheckmarkIcon />
              </div>
              <p className="ml-3 text-base font-medium leading-6 text-gray-500">Dolorem vero ratione voluptates</p>
            </li>
            <li className="flex items-start mt-4">
              <div className="flex-shrink-0">
                <CheckmarkIcon />
